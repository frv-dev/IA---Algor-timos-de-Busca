...
def aprofundamento_iterativo(matrix: np.ndarray, nodes: list, start, end, limit_max):
    for limit in range(1, limit_max + 1):
        myList_1 = MyList()
        myList_2 = MyList()
        visited = list()
    ...
    return "Caminho não encontrado com o limite máximo " + str(limit)
